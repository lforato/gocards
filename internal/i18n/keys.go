...
// Shared delete-lifecycle keys.
const (
	KeyDeleteFailedPfx     Key = "common.delete_failed_prefix"
	KeyDeletedDeckFmt      Key = "common.deleted_deck_fmt"
	KeyDeletedCardsFmt     Key = "common.deleted_cards_fmt"
	KeyBulkDeleteFailedFmt Key = "common.bulk_delete_failed_fmt"
)
...
const (
	...
	KeyStudyFillScoreFmt    Key = "study.fill.score_fmt"
	KeyStudyAnswerYours     Key = "study.answer.yours"
	KeyStudyAnswerAnnotated Key = "study.answer.annotated"
